...
| `domain_events`                                | event payloads — **id-only by design** (ADR-0011 posture; verified: booking snapshots carry ids/times, no names/phones) | operational history                               | keep (pseudonymous)                                                                                                     |
